...
INSERT INTO mail_templates (id, name, subject, body, keys, provider_email, created_by, created_at, updated_at) VALUES
...
', '{user, link}', 'toplaiphaiwin@gmail.com', null, NOW(), NOW());